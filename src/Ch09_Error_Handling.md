...
## <a id="recoverable-errors-with-result"></a>带有 `Result` 的可恢复错误
...
### <a id="shortcuts-for-panic-on-error-unwrap-and-expect"></a>因错误而中止的快捷方式：`unwrap` 与 `expect`
...
### <a id="a-shortcut-for-propagating-errors-the-question-mark-operator"></a>传递错误的快捷方式：`?` 操作符
...
### <a id="cases-in-which-you-have-more-information-than-the-compiler"></a>相比于编译器，代码编写者掌握了更多信息的情形
...
### <a id="guidelines-for-error-handling"></a>错误处理守则
...
### <a id="creating-custom-types-for-validation"></a>创建用于验证的定制类型
