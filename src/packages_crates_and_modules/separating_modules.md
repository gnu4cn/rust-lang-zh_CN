...
例如，我们来从 [清单 7-17](./the_use_keyword.md#listing_7-17) 中，包含了多个餐厅模组的代码开始。我们将把这些模组提取到一些文件中，而不是把所有模组都定义在代码箱的根文件里。在本例中，代码箱的根文件为 `src/lib.rs`，但这一过程也适用于根文件为 `src/main.rs` 的二进制代码箱。
